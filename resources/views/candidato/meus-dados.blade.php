...
<div class="max-w-3xl mx-auto mt-6 space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 transition-colors duration-300">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Mantenha seu endereço atualizado para futuras adoções.</p>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 transition-colors duration-300">
        ...
        <h2 class="text-lg font-bold text-gray-700 dark:text-gray-200 mb-4 border-t dark:border-gray-700 pt-6">Atualizar Endereço</h2>
        ...
        <form action="{{ route('perfil.atualizar') }}" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" id="cep" name="cep" required maxlength="9" placeholder="00000-000" value="{{ old('cep', $usuario->cep) }}" class="w-full border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 rounded-lg p-2.5 text-gray-900 dark:!text-white focus:ring-2 focus:ring-indigo-500 outline-none transition" onblur="buscarCep()">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="logradouro" name="logradouro" required value="{{ old('logradouro', $usuario->logradouro) }}" class="w-full border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800/80 text-gray-800 dark:!text-gray-300 rounded-lg p-2.5 font-medium" readonly>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                    ...
                    <input type="text" id="numero" name="numero" required value="{{ old('numero', $usuario->numero) }}" class="w-full border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 rounded-lg p-2.5 text-gray-900 dark:!text-white focus:ring-2 focus:ring-indigo-500 outline-none">
                </div>
                <div>
                    <label class="block text-gray-700 dark:text-gray-300 font-semibold mb-1">Bairro</label>
                    <input type="text" id="bairro" name="bairro" required value="{{ old('bairro', $usuario->bairro) }}" class="w-full border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800/80 text-gray-800 dark:!text-gray-300 rounded-lg p-2.5 font-medium" readonly>
                </div>
                <div>
                    <label class="block text-gray-700 dark:text-gray-300 font-semibold mb-1">Cidade</label>
                    <input type="text" id="cidade" name="cidade" required value="{{ old('cidade', $usuario->cidade) }}" class="w-full border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800/80 text-gray-800 dark:!text-gray-300 rounded-lg p-2.5 font-medium" readonly>
                </div>
                <div>
                    <label class="block text-gray-700 dark:text-gray-300 font-semibold mb-1">UF</label>
                    <input type="text" id="uf" name="uf" required value="{{ old('uf', $usuario->uf) }}" class="w-full border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800/80 text-gray-800 dark:!text-gray-300 rounded-lg p-2.5 font-medium" readonly>
                </div>
            </div>

            <button type="submit" class="w-full bg-indigo-600 text-white py-3 rounded-lg font-semibold hover:bg-indigo-700 shadow-md transition">
                Salvar Alterações
            </button>
        </form>
    </div>
